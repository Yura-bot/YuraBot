const languageData = {
    ...
    /* FUN : */
    /* 8ball : */
    QUESTION_BALL: "S'il te plaît, pose-moi une question !",
    BALL: "8ball",
    QUESTION: "Question :",
    REPONSE: "Réponse :",
    YES: "Oui !",
    ...
    GIVEAWAY_END_ID_INVALIDE: "<:X_:673212163837526064> Vous devez spécifier un ID de message valide !",
    ...
    SYNTAXE_GIVEAWAY_REROLL: ":x: reroll-giveaway [Message ID du Giveaway]```",
    ...
    BAN: "ban",
    AUTOBAN: "Tu ne peux pas te ban !",
    BANYURA: "Comment peux-tu utiliser un robot pour se bannir ? :joy :",
    BANDEV: "Tu ne peux pas ban ce membre ! :wink:",
    ...
    BAN_SUCESS_1: "<:X_:673212163837526064> Vous êtes fait bannir sur **",
    BAN_SUCESS_2: "** par __",
    ...
    AUTOKICK: "Je ne peux pas vous laisser faire ça, l'automutilation est mauvaise !",
    YURAKICK: "Pleblord, comment peut-on utiliser un bot pour se donner un coup de pied ?",
    KICK_DEV: "Vous ne pouvez pas kicker mon Developer !",
    KICK: "kick",
    KICK_ERROR: "Je ne peux pas kicker ce membre !",
    KICK_SUCESS_1: "<:X_:673212163837526064> Vous êtes fait expuser sur **",
    ...
    TEMPMUTE: "tempmute",
    AUTOTEMPMUTE: "Vous ne pouvez pas vous mute vous même !",
    USERMUTE: "L'utilisateur donné est déjà mute !",
    ...
    TEMPMUTE_UNMUTE_CHANNEL_1: "Le membre <@",
    ...
    CALC: "calc",
    CALC_ERROR: "Vérifiez votre opération !",
    CALC_SUCESS: "```Résultat :\n\n",
    /* Commande Finduser : */
    SYNTAXE_FINDUSER: "Veuillez fournir le nom d’une personne dans ce serveur !",
    FINDUSER: "finduser",
    /* Commande Hastebin : */
    ...
    /* Commande STATS : */
    STATS: "stats",
    STATS_USERS: "Statistiques du l'utilisateur **",
    STATS_ID: ":nerd: - **Pseudo, ID** :",
    STATS_CREATEDAT: ":hourglass: - **Crée le ** :",
    STATS_GAME: ":video_game: - **Jeu** >",
    STATS_NO_GAME: "Aucun jeu",
    STATS_JOINAT: ":wave: - **Rejoin le** :",
    STATS_INFOS: "Informations de l'utilisateur ",
    /* Commande SUGGEST : */

const languageData = {
    ...
    /* Giveaway Config : */
    GIVEAWAY_CONFIG_CHANNEL: "**<:horizontalsettingsmixer:675372744950677534> Please send in the chat following this message `the channel` in which the giveaway will appear.**",
    GIVEAWAY_CONFIG_DURATION: "**<:horizontalsettingsmixer:675372744950677534> Please send in the chat following this message `the time` during which members will be able to participate.**",
    GIVEAWAY_CONFIG_NW: "**<:horizontalsettingsmixer:675372744950677534> Please send in the chat following this message `the number of winners` who will receive the prize.**",
    GIVEAWAY_CONFIG_PRIZE: "**<:horizontalsettingsmixer:675372744950677534> Please send in the chat following this message `the prize` that the winner(s) will win.**",
    GIVEAWAY_CONFIG_ROLE: "**<:horizontalsettingsmixer:675372744950677534> Please send in the chat following this message `a required role` to participate in the giveaway.**",

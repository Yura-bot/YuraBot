...
class GiveawaysManager extends EventEmitter {
    ...
    generateMainEmbed(giveaway) {
        ...
        if (giveaway.extraData.roles[0]) embed.addField(giveaway.messages.conditionRole, this.client.guilds.cache.get(giveaway.guildID).roles.cache.get(giveaway.extraData.roles[0]))
        return embed;
    }
